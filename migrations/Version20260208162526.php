 ...
 */
final class Version20260208162526 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX event_id ON salle');
        $this->addSql('ALTER TABLE salle CHANGE image_3d image_3d VARCHAR(255) DEFAULT NULL, CHANGE equipment equipment LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE salle CHANGE image_3d image_3d VARCHAR(255) DEFAULT \'NULL\', CHANGE equipment equipment TEXT DEFAULT NULL');
        $this->addSql('CREATE INDEX event_id ON salle (event_id)');
