    ...
    public function register(Request $request): Response
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            if (!empty($emailErrors)) {
                ...
                if ($existingUser) {
                    $errors[] = 'An account with this email already exists. <a href="' . $this->generateUrl('auth_login') . '" class="underline font-semibold">Sign in instead?</a>';
                }
            }
            ...
            if (empty($passwordConfirm)) {
                ...
                $errors[] = 'Passwords do not match. Please make sure both password fields are identical.';
            }
